...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `yii2DB`.`clndr_user` ;

CREATE TABLE IF NOT EXISTS `yii2DB`.`clndr_user` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `yii2DB`.`clndr_calendar` ;

CREATE TABLE IF NOT EXISTS `yii2DB`.`clndr_calendar` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  ...
  CONSTRAINT `fk_evrnt_note_1`
    FOREIGN KEY (`creator`)
    REFERENCES `yii2DB`.`clndr_user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `yii2DB`.`clndr_access` ;

CREATE TABLE IF NOT EXISTS `yii2DB`.`clndr_access` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
